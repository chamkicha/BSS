...
<table class="table table-striped table-bordered" id="productTypes-table" width="100%">
    ...
    @foreach($productTypes as $productType)
        <tr>
            ...
            <td>
                 <a href="{{ route('admin.productType.productTypes.show', collect($productType)->first() ) }}">
                     <i class="livicon" data-name="info" data-size="18" data-loop="true" data-c="#428BCA" data-hc="#428BCA" title="view productType"></i>
                 </a>
                 <a href="{{ route('admin.productType.productTypes.edit', collect($productType)->first() ) }}">
                     <i class="livicon" data-name="edit" data-size="18" data-loop="true" data-c="#428BCA" data-hc="#428BCA" title="edit productType"></i>
                 </a>
                 <a href="{{ route('admin.productType.productTypes.confirm-delete', collect($productType)->first() ) }}" data-toggle="modal" data-target="#delete_confirm" data-id="{{ route('admin.productType.productTypes.delete', collect($productType)->first() ) }}">
