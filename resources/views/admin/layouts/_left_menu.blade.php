<ul id="menu" class="page-sidebar-menu">
 ...
 @if (Sentinel::inRole('admin') or Sentinel::inRole('finance') )
...
@endif
    ...
    <li {!! (Request::is('admin/productrevenue/productRevenues*') || Request::is('admin/agingAnalysisReport/aginganalysisreports*') || Request::is('admin/revenuePerCustomerReport/revenuePerCustomerReports*') || Request::is('admin/agingAnalysisReport/agingAnalysisReports*') ? 'class="active"' : '' ) !!}>
        ...
        <ul class="sub-menu">
            <li {!! (Request::is('admin/revenuePerCustomerReport/revenuePerCustomerReports*') ? 'class="active" id="active"' : '' ) !!}>
            ...
            <li {!! (Request::is('admin/agingAnalysisReport/aginganalysisreports*') ? 'class="active" id="active"' : '' ) !!}>
    ...
    <li {!! (Request::is('admin/productrevenue/productRevenues*') || Request::is('admin/agingAnalysisReport/aginganalysisreports*') || Request::is('admin/revenuePerCustomerReport/revenuePerCustomerReports*') || Request::is('admin/agingAnalysisReport/agingAnalysisReports*') ? 'class="active"' : '' ) !!}>
        ...
        <ul class="sub-menu">
            <li {!! (Request::is('admin/invoiceDublication/invoiceDublications*') ? 'class="active" id="active"' : '' ) !!}>
