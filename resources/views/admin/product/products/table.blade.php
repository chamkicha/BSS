    ...
    @foreach($products as $product)
        <tr>
            ...
            <td>
                 ...
                 <a href="{{ route('admin.product.products.confirm-delete', collect($product)->first() ) }}" data-toggle="modal" data-target="#delete_confirm" data-id="{{ route('admin.product.products.delete', collect($product)->first() ) }}">
