...
<link href="<?php echo e(asset('css/pages/form2.css')); ?>" rel="stylesheet" />
<link href="<?php echo e(asset('css/pages/form3.css')); ?>" rel="stylesheet" />
...
<style>
    .iti-flag {
        background-image: url(<?php echo e(asset('vendors/intl-tel-input/flags.png')); ?>);
    }
...
<script src="<?php echo e(asset('js/pages/validation.js')); ?>" type="text/javascript"></script>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\BSS\resources\views/admin/validation.blade.php ENDPATH**/ ?>