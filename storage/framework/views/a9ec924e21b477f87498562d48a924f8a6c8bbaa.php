...
<?php $__env->startSection('header_styles'); ?>
    <link href="<?php echo e(asset('css/pages/formbuilder1.css')); ?>"  rel="stylesheet"/>
    <link href="<?php echo e(asset('css/pages/form_builder2.css')); ?>"  rel="stylesheet"/>
...
<?php $__env->startSection('footer_scripts'); ?>
    ...
    <script src="<?php echo e(asset('vendors/form-builder/js/beautify-html.js')); ?>" ></script>
    <script src="<?php echo e(asset('vendors/form-builder/js/beautify-css.js')); ?>" ></script>
    <script src="<?php echo e(asset('vendors/form-builder/js/beautify.js')); ?>" ></script>
    <script src="<?php echo e(asset('js/pages/form_builder2.js')); ?>" ></script>
<script src="<?php echo e(asset('js/pages/jquery-ui.min.js')); ?>" ></script>


<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\BSS\resources\views/admin/form_builder2.blade.php ENDPATH**/ ?>