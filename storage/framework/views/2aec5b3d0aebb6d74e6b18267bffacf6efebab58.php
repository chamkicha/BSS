...
<link rel="stylesheet" media="all" href="<?php echo e(asset('vendors/bower-jvectormap/css/jquery-jvectormap-1.2.2.css')); ?>" />
                ...
                <div class="card-body nopadmar top_height">
                    ...
                    <div class="add_list adds bg_white">
                        ...
                        <div class="form-group">
                            ...
                            <?php echo Form::text('task_description', null, ['class' =>
                        ...
                        <div class="form-group">
                            ...
                            <?php echo Form::text('task_deadline', null, ['class' => 'form-control datepicker',
...
<script type="text/javascript"
    src="<?php echo e(asset('vendors/bootstrap-datetime-picker/js/bootstrap-datetimepicker.min.js')); ?>"></script>

<!-- EASY PIE CHART JS -->
<script src="<?php echo e(asset('vendors/bower-jquery-easyPieChart/js/easypiechart.min.js')); ?>"></script>
<script src="<?php echo e(asset('vendors/bower-jquery-easyPieChart/js/jquery.easypiechart.min.js')); ?>"></script>
<script src="<?php echo e(asset('vendors/bower-jquery-easyPieChart/js/jquery.easingpie.js')); ?>"></script>
<!--for calendar-->
<script src="<?php echo e(asset('vendors/moment/js/moment.min.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('vendors/fullcalendar/js/fullcalendar.min.js')); ?>" type="text/javascript"></script>
<!--   Realtime Server Load  -->
<script src="<?php echo e(asset('vendors/flotchart/js/jquery.flot.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('vendors/flotchart/js/jquery.flot.resize.js')); ?>" type="text/javascript"></script>
<!--Sparkline Chart-->
<script src="<?php echo e(asset('vendors/sparklinecharts/jquery.sparkline.js')); ?>"></script>
<!-- Back to Top-->
<script type="text/javascript" src="<?php echo e(asset('vendors/countUp.js/js/countUp.js')); ?>"></script>
<!--   maps -->
<script src="<?php echo e(asset('vendors/bower-jvectormap/js/jquery-jvectormap-1.2.2.min.js')); ?>"></script>
<script src="<?php echo e(asset('vendors/bower-jvectormap/js/jquery-jvectormap-world-mill-en.js')); ?>"></script>
<!--  todolist-->
<script src="<?php echo e(asset('js/pages/todolist.js')); ?>"></script>
<script src="<?php echo e(asset('js/pages/dashboard.js')); ?>" type="text/javascript"></script>
...
<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\BSS\resources\views/admin/index.blade.php ENDPATH**/ ?>