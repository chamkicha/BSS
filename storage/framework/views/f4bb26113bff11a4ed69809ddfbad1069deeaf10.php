<?php $__env->startSection('title'); ?>
   Radio And Checkbox
    ...
    <?php $__env->startSection('header_styles'); ?>
        <link rel="stylesheet" type="text/css" href="<?php echo e(asset('vendors/iCheck/css/all.css')); ?>"/>
        <link rel="stylesheet" type="text/css" href="<?php echo e(asset('vendors/iCheck/css/line/line.css')); ?>"/>
        <link rel="stylesheet" type="text/css" href="<?php echo e(asset('vendors/bootstrap-switch/css/bootstrap-switch.css')); ?>"/>
        <link rel="stylesheet" type="text/css" href="<?php echo e(asset('vendors/switchery/css/switchery.css')); ?>"/>
        <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/pages/formelements.css')); ?>"/>
        <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/plugins/awesome-bootstrap-checkbox.css')); ?>"/>
<?php $__env->stopSection(); ?>
...
<div class="row">
    ...
    <script language="javascript" type="text/javascript" src="<?php echo e(asset('vendors/bootstrap-switch/js/bootstrap-switch.js')); ?>"></script>
    <script language="javascript" type="text/javascript" src="<?php echo e(asset('vendors/switchery/js/switchery.js')); ?>" ></script>
    <script language="javascript" type="text/javascript" src="<?php echo e(asset('vendors/bootstrap-maxlength/js/bootstrap-maxlength.js')); ?>"></script>
    <script language="javascript" type="text/javascript" src="<?php echo e(asset('vendors/card/js/jquery.card.js')); ?>"></script>
    <script language="javascript" type="text/javascript" src="<?php echo e(asset('js/pages/radio_checkbox.js')); ?>"></script>

    <?php $__env->stopSection(); ?>

<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\BSS\resources\views/admin/radio_checkbox.blade.php ENDPATH**/ ?>