...
<table class="table table-striped table-bordered" id="unitofMeasures-table" width="100%">
    ...
    <tbody>
    <?php $__currentLoopData = $unitofMeasures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unitofMeasure): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
            <td><?php echo $unitofMeasure->unitof_measure_name; ?></td>
            <td><?php echo $unitofMeasure->description; ?></td>
            <td>
                 <a href="<?php echo e(route('admin.unitofMeasure.unitofMeasures.show', collect($unitofMeasure)->first() )); ?>">
                     <i class="livicon" data-name="info" data-size="18" data-loop="true" data-c="#428BCA" data-hc="#428BCA" title="view unitofMeasure"></i>
                 </a>
                 <a href="<?php echo e(route('admin.unitofMeasure.unitofMeasures.edit', collect($unitofMeasure)->first() )); ?>">
                     <i class="livicon" data-name="edit" data-size="18" data-loop="true" data-c="#428BCA" data-hc="#428BCA" title="edit unitofMeasure"></i>
                 </a>
                 <a href="<?php echo e(route('admin.unitofMeasure.unitofMeasures.confirm-delete', collect($unitofMeasure)->first() )); ?>" data-toggle="modal" data-target="#delete_confirm" data-id="<?php echo e(route('admin.unitofMeasure.unitofMeasures.delete', collect($unitofMeasure)->first() )); ?>">
...
<?php /**PATH C:\xampp\htdocs\BSS\resources\views/admin/unitofMeasure/unitofMeasures/table.blade.php ENDPATH**/ ?>