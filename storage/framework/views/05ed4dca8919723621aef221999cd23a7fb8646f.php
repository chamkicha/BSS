...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/frontend/custom1.css')); ?>">
    <!--end of global css-
    <!--page level css-->
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto  margin_right">
                        ...
                        <li
                            class=" nav-item dropdown  <?php echo (Request::is('typography') || Request::is('advanced_features') || Request::is('grid') ? 'active' : ''); ?>">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li><a href="<?php echo e(URL::to('advanced_features')); ?>" class="dropdown-item">Advanced
                                        Features</a>
                                </li>
                        ...
                        <li
                            class=" nav-item dropdown <?php echo (Request::is('about_us') || Request::is('timeline') || Request::is('faq') || Request::is('blank_page')  ? 'active' : ''); ?>">
                            <a href="#" class="nav-link"> Pages</a>
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="<?php echo e(URL::to('about_us')); ?>" class="dropdown-item">About Us</a>
                                </li>
                        ...
                        <li
                            class="nav-item dropdown <?php echo (Request::is('products') || Request::is('single_product') || Request::is('compareproducts') || Request::is('category')  ? 'active' : ''); ?>">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li><a href="<?php echo e(URL::to('compareproducts')); ?>" class="dropdown-item">Compare
                                        Products</a>
                                </li>
                        ...
                        <li
                            class="nav-item dropdown <?php echo (Request::is('portfolio') || Request::is('portfolioitem') ? 'active' : ''); ?>">
                        ...
                        <li
                            class=" nav-item dropdown <?php echo (Request::is('user_emails/inbox') || Request::is('user_emails/compose') || Request::is('user_emails/sent') ? 'active' : ''); ?>">
                    ...
                    'news*') ? 'active' : ''); ?>"><a href="<?php echo e(URL::to('news')); ?>" class="nav-link">News</a>
                        ...
                        <li class="nav-item <?php echo (Request::is(
                    'blog') || Request::is('blogitem/*') ? 'active' : ''); ?>"><a href="<?php echo e(URL::to('blog')); ?>"
                                class="nav-link">
                                Blog</a>
                        </li>
                        <li class="nav-item <?php echo (Request::is(
                    'contact') ? 'active' : ''); ?>"><a href="<?php echo e(URL::to('contact')); ?>" class="nav-link">Contact</a>
                        ...
                        <?php else: ?>
                        <li class="nav-item <?php echo e((Request::is('my-account') ? 'active' : '')); ?>"><a
                                href="<?php echo e(URL::to('my-account')); ?>" class="nav-link">My
                                Account</a>
                        </li>
...
<?php /**PATH C:\xampp\htdocs\BSS\resources\views/layouts/default.blade.php ENDPATH**/ ?>