...
<table class="table table-striped table-bordered" id="products-table" width="100%">
    ...
    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
            ...
            <td><?php echo $product->v_a_t; ?></td>
            <td><?php echo $product->e_d; ?></td>
            <td><?php echo $product->price; ?></td>
            <td><?php echo $product->discount; ?></td>
            <td>
                 <a href="<?php echo e(route('admin.product.products.show', collect($product)->first() )); ?>">
                     <i class="livicon" data-name="info" data-size="18" data-loop="true" data-c="#428BCA" data-hc="#428BCA" title="view product"></i>
                 </a>
                 <a href="<?php echo e(route('admin.product.products.edit', collect($product)->first() )); ?>">
                     <i class="livicon" data-name="edit" data-size="18" data-loop="true" data-c="#428BCA" data-hc="#428BCA" title="edit product"></i>
                 </a>
                 <a href="<?php echo e(route('admin.product.products.confirm-delete', collect($product)->first() )); ?>" data-toggle="modal" data-target="#delete_confirm" data-id="<?php echo e(route('admin.product.products.delete', collect($product)->first() )); ?>">
...
<?php /**PATH C:\xampp\htdocs\BSS\resources\views/admin/product/products/table.blade.php ENDPATH**/ ?>