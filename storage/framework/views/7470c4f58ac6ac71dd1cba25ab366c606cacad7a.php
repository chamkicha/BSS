    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-lg-12 my-3">
            <div class="card ">
                ...
                <div class="card-body">
                    <!--main content-->
                    <?php echo Form::model($user, ['url' => URL::to('admin/users/'. $user->id.''), 'method' => 'put', 'class'
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" title="Select Gender..." name="gender">
                                                ...
                                                <option value="male" <?php if($user->gender === 'male'): ?> selected="selected"
                                                    <?php endif; ?> >Male</option>
                                                <option value="female" <?php if($user->gender === 'female'): ?>
                                                    selected="selected" <?php endif; ?> >Female</option>
                                                <option value="other" <?php if($user->gender === 'other'): ?> selected="selected"
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control required" title="Select role..."
                                                ...
                                                <option value="<?php echo $role->id; ?>"
                                                    <?php echo e((array_key_exists($role->id, $userRoles) ? ' selected="selected"' : '')); ?>

                                                    <?php if($user->id==1&&$role->id>=2): ?> disabled <?php endif; ?> <?php if($user->id==2 &&
                                                    $role->id!=2): ?> disabled <?php endif; ?>><?php echo e($role->name); ?></option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            <input id="activate" name="activate" type="checkbox"
                                                class="pos-rel p-l-30 custom-checkbox" value="1" <?php if($status): ?>
...
<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\BSS\resources\views/admin/users/edit.blade.php ENDPATH**/ ?>