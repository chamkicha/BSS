            ...
            <div class="card card-border">
                ...
                <div class="card-body nopadmar users">
                    ...
                    <div class="media">
                        <div>
                            <?php if($user->pic): ?>
                            <img src="<?php echo e($user->pic); ?>" class="media-object rounded-circle">
                            <?php else: ?>
                ...
                <div class="card-body nopadmar blogs">
                    ...
                    <div class="media">
                        <div>
                            ...
                            <img src="<?php echo e($blog->author->pic); ?>" class="media-object rounded-circle">
                            <?php else: ?>
                            <img src="<?php echo e(asset('images/authors/no_avatar.jpg')); ?>" class="media-object rounded-circle">
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="media-body ml-3">
                            ...
                            <p>category: <?php echo e($blog->category->title); ?> <span class="user_create_date float-right">by
                                    <?php echo e($blog->author->full_name); ?> </span></p>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<script>
    ...
    <!-- prettier-ignore -->
    var demo = new CountUp("myTargetElement1", 12.52, <?php echo $pageVisits; ?>, 0, 6, options);
    demo.start();
    <!-- prettier-ignore -->
    var demo = new CountUp("myTargetElement2", 1, <?php echo $blog_count; ?>, 0, 6, options);
    demo.start();
    <!-- prettier-ignore -->
    ...
    var user_types = <?php echo $userTypes; ?>
...
<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\BSS\resources\views/admin/index1.blade.php ENDPATH**/ ?>