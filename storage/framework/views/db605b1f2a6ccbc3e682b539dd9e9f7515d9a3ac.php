...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/frontend/tabbular.css')); ?>">
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('vendors/animate/animate.min.css')); ?>" />
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/frontend/jquery.circliful.css')); ?>">
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('vendors/owl_carousel/css/owl.carousel.css')); ?>">
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('vendors/owl_carousel/css/owl.theme.css')); ?>">
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/frontend/index.css')); ?>">
...
<div id="owl-demo" class="owl-carousel owl-theme">
    <div class="item img-fluid"><img src="<?php echo e(asset('images/slide_1.jpg')); ?>" alt="slider-image" />
    </div>
    <div class="item img-fluid"><img src="<?php echo e(asset('images/slide_2.jpg')); ?>" alt="slider-image">
    </div>
    <div class="item img-fluid"><img src="<?php echo e(asset('images/slide_4.png')); ?>" alt="slider-image">
    </div>
</div>
<!-- //Carousel End -->
<?php $__env->stopSection(); ?>
        ...
        <div class="row">
            <div class="col-md-8 col-sm-8 col-12 col-lg-9 wow zoomIn" data-wow-duration="2s">
                <div class="layout-image">
                    <img src="<?php echo e(asset('images/layout.png')); ?>" alt="layout" class="img-fluid" />
                </div>
            </div>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_default_1">
                            <div class="media">
                                <div class="media-left tab col-sm-12">
                                    <a href="#">
                                        <img class="media-object img-fluid" src="<?php echo e(asset('images/authors/img1.jpg')); ?>"
                                            alt="image">
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="tab_default_2">
                            <div class="media">
                                <div class="media-left media-middle tab col-sm-12">
                                    <a href="#">
                                        <img class="media-object img-fluid" src="<?php echo e(asset('images/authors/img2.jpg')); ?>"
                                            alt="image">
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="tab_default_3">
                            <div class="media">
                                <div class="media-left media-middle tab col-sm-12">
                                    <a href="#">
                                        <img class="media-object img-fluid" src="<?php echo e(asset('images/authors/img3.jpg')); ?>"
                                            alt="image">
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="tab_default_4">
                            <div class="media">
                                <div class="media-left media-middle tab col-sm-12">
                                    <a href="#">
                                        <img class="media-object img-fluid" src="<?php echo e(asset('images/authors/img4.jpg')); ?>"
                                            alt="image">
                                    </a>
                                </div>
                            </div>
...
<div class="container">
    ...
    <div class="row text-center">
        <div class="col-md-6 col-sm-6 col-12 col-lg-3 profile wow fadeInLeft" data-wow-duration="3s"
            ...
            <div class="thumbnail bg-white">
                <img src="<?php echo e(asset('images/img_3.jpg')); ?>" alt="team-image" class="img-fluid">
                <div class="caption">
                    <b>John Doe</b>
        ...
        <div class="col-md-6 col-sm-6 col-lg-3 col-12 profile wow fadeInUp" data-wow-duration="3s"
            data-wow-delay="0.5s">
            <div class="thumbnail bg-white">
                <img src="<?php echo e(asset('images/img_5.jpg')); ?>" alt="team-image">
                <div class="caption">
        ...
        <div class="col-md-6 col-sm-6 col-lg-3 col-12 profile wow fadeInDown" data-wow-duration="3s"
            data-wow-delay="0.5s">
            <div class="thumbnail bg-white">
                <img src="<?php echo e(asset('images/img_4.jpg')); ?>" alt="team-image" class="img-fluid">
                <div class="caption">
                    <b>Audrey Sheldon</b>
        ...
        <div class="col-md-6 col-sm-6 col-lg-3 col-12 profile wow fadeInRight" data-wow-duration="3s"
            data-wow-delay="0.5s">
            <div class="thumbnail bg-white">
                <img src="<?php echo e(asset('images/img_6.jpg')); ?>" alt="team-image">
                <div class="caption">
                    <b>Sam Bellows</b>
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-sm-6 col-lg-6 col-12 wow zoomInLeft" data-wow-duration="3s">
            ...
            <img src="<?php echo e(asset('images/image_12.jpg')); ?>" alt="image_12" class="img-fluid">
            <p>
        ...
        <div class="col-md-6 col-sm-6 col-lg-6 col-12 wow zoomInRight" data-wow-duration="3s">
            ...
            <img src="<?php echo e(asset('images/image_11.jpg')); ?>" alt="image_11" class="img-fluid">
            <p>
                Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the
                industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and
                scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap
    ...
    <div class="row">
        ...
        <div class="col-md-4  col-lg-4 col-12 wow bounceInLeft" data-wow-duration="3s">
            <div class="author">
                <img src="<?php echo e(asset('images/authors/avatar3.jpg')); ?>" alt="avatar3"
        ...
        <div class="col-md-4  col-12 col-lg-4 wow bounceIn" data-wow-duration="3s">
            <div class="author">
                <img src="<?php echo e(asset('images/authors/avatar2.jpg')); ?>" alt="avatar2"
                    class="img-fluid rounded-circle float-left">
                <p class="text-right">
                    Tonny Jakson
                    <br>
        ...
        <div class="col-md-4  col-lg-4 col-12 wow bounceInRight" data-wow-duration="3s">
            <div class="author">
                <img src="<?php echo e(asset('images/authors/avatar4.jpg')); ?>" alt="avatar4"
                    class="img-fluid rounded-circle float-left">
                <p class="text-right">
                    Tonny Jakson
                    <br>
...
<script type="text/javascript" src="<?php echo e(asset('js/frontend/jquery.circliful.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('vendors/wow/js/wow.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('vendors/owl_carousel/js/owl.carousel.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('js/frontend/carousel.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('js/frontend/index.js')); ?>"></script>
<!--page level js ends-->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\BSS\resources\views/index.blade.php ENDPATH**/ ?>