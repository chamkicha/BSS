                                ...
                                <td height="60" style="background-color:#403e3e;font-family: 'Montserrat',Arial, sans-serif;font-size:26px;font-weight:500;letter-spacing:1px;line-height:30px;" align="center">
                                    <center>
                                        <img data-crop="false" style="display:block;"
                                             src="<?php echo e(asset('images/logo.png')); ?>" alt="img"/>
                                    </center>
                                </td>
                            </tr>
                            <tr height="50"></tr>
...
<?php echo $__env->make('emails/layouts/emailTemplate', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\BSS\resources\views/emails/emailTemplates/forgot.blade.php ENDPATH**/ ?>