...
<?php $__env->startSection('header_styles'); ?>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('vendors/datatables/css/colReorder.bootstrap4.css')); ?>"/>
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('vendors/datatables/css/rowReorder.bootstrap4.css')); ?>"/>
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('vendors/datatables/css/scroller.bootstrap4.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('vendors/bootstrap-slider/css/bootstrap-slider.min.css')); ?>" />
    <link href="<?php echo e(asset('vendors/iCheck/css/all.css')); ?>"  rel="stylesheet" type="text/css" />
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/pages/tables.css')); ?>" />
    <style>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 my-2">
                                    ...
                                    <div> <b class="margin_right15"> <?php echo e($min_id); ?> </b>
                                        ...
                                        <input id="ex8" type="text" data-slider-id='ex1Slider' class="slider form-control" data-slider-handle="square" value="" data-slider-min="<?php echo e($min_id); ?>" data-slider-max="<?php echo e($max_id); ?>" data-slider-step="1" data-slider-value="[<?php echo e($min_id); ?>,<?php echo e($max_id); ?>]" data-slider-tooltip="show"/> <b style="margin-left: 15px;"><?php if(!empty($max_count)): ?><?php echo e($max_id); ?> <?php else: ?> 10 <?php endif; ?></b>
...
<?php $__env->startSection('footer_scripts'); ?>
    ...
    <script type="text/javascript" src="<?php echo e(asset('vendors/jeditable/js/jquery.jeditable.js')); ?>" ></script>
    <script type="text/javascript" src="<?php echo e(asset('vendors/datatables/js/dataTables.bootstrap4.js')); ?>" ></script>
    <script type="text/javascript" src="<?php echo e(asset('vendors/datatables/js/dataTables.buttons.js')); ?>" ></script>
    <script type="text/javascript" src="<?php echo e(asset('vendors/datatables/js/dataTables.colReorder.js')); ?>" ></script>
    <script type="text/javascript" src="<?php echo e(asset('vendors/datatables/js/dataTables.responsive.js')); ?>" ></script>
    <script type="text/javascript" src="<?php echo e(asset('vendors/datatables/js/dataTables.rowReorder.js')); ?>" ></script>
    <script type="text/javascript" src="<?php echo e(asset('vendors/datatables/js/buttons.colVis.js')); ?>" ></script>
    <script type="text/javascript" src="<?php echo e(asset('vendors/datatables/js/buttons.html5.js')); ?>" ></script>
    <script type="text/javascript" src="<?php echo e(asset('vendors/datatables/js/buttons.print.js')); ?>" ></script>
    <script type="text/javascript" src="<?php echo e(asset('vendors/datatables/js/buttons.bootstrap4.js')); ?>" ></script>
    <script type="text/javascript" src="<?php echo e(asset('vendors/datatables/js/buttons.print.js')); ?>" ></script>
    <script type="text/javascript" src="<?php echo e(asset('vendors/datatables/js/pdfmake.js')); ?>" ></script>
    <script type="text/javascript" src="<?php echo e(asset('vendors/datatables/js/vfs_fonts.js')); ?>" ></script>
    <script type="text/javascript" src="<?php echo e(asset('vendors/datatables/js/dataTables.scroller.js')); ?>" ></script>
    <script src="<?php echo e(asset('vendors/bootstrap-slider/js/bootstrap-slider.js')); ?>" ></script>
...
<?php echo $__env->make('admin.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\BSS\resources\views/admin/examples/custom_datatables.blade.php ENDPATH**/ ?>