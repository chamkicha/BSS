...
<link href="<?php echo e(asset('vendors/noty/css/noty.css')); ?>" rel="stylesheet" />
    <link href="<?php echo e(asset('css/pages/fluid.css')); ?>"  rel="stylesheet"/>
    <link href="<?php echo e(asset('css/pages/toastr.css')); ?>" rel="stylesheet" />
...
<?php $__env->startSection('footer_scripts'); ?>
    ...
    <script src="<?php echo e(asset('vendors/noty/js/noty.js')); ?>" ></script>
<script src="<?php echo e(asset('js/pages/jquery.noty.packaged.min.js')); ?>" ></script>
<script src="<?php echo e(asset('js/pages/noty_script.js')); ?>" ></script>


<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\BSS\resources\views/admin/notifications.blade.php ENDPATH**/ ?>