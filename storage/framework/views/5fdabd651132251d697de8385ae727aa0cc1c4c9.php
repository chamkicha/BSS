...
<?php $__env->startSection('header_styles'); ?>
    ...
    <link href="<?php echo e(asset('vendors/jasny-bootstrap/css/jasny-bootstrap.css')); ?>" rel="stylesheet" type="text/css" />
    
    <link href="<?php echo e(asset('vendors/bootstrap-magnify/bootstrap-magnify.css')); ?>" rel="stylesheet" />
    <link href="<?php echo e(asset('vendors/iCheck/css/all.css')); ?>" rel="stylesheet"/>
    <link href="<?php echo e(asset('css/pages/user_profile.css')); ?>" rel="stylesheet" type="text/css"/>
    <style>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="col-md-3 col-6">
                                                <div class="mag img-fluid">
                                                    <br />
                                                    <img data-toggle="magnify" class="thumbnail img-fluid" src="<?php echo e(asset('img/authors/avatar.jpg')); ?>" alt=""></div>
                                            </div>
                                            <div class="col-md-3 col-6">
                                                <div class="mag img-fluid">
                                                    <br />
                                                    <img data-toggle="magnify" src="<?php echo e(asset('img/authors/avatar3.jpg')); ?>" alt="" class="thumbnail img-fluid"></div>
                                            </div>
                                            <div class="col-md-3 col-6">
                                                <div class="mag img-fluid">
                                                    <br />
                                                    <img data-toggle="magnify" src="<?php echo e(asset('img/authors/avatar7.jpg')); ?>" alt="" class="thumbnail img-fluid"></div>
                                            </div>
                                            <div class="col-md-3 col-6">
                                                <div class="mag img-fluid">
                                                    <br />
                                                    <img data-toggle="magnify" src="<?php echo e(asset('img/authors/avatar5.jpg')); ?>" alt="" class="thumbnail img-fluid"></div>
                                            </div>
                                            ...
                                            <div class="col-md-3 col-6">
                                                <div class="mag img-fluid">
                                                    <br />
                                                    <img data-toggle="magnify" src="<?php echo e(asset('img/authors/avatar4.jpg')); ?>" alt="" class="thumbnail img-fluid"></div>
                                            </div>
                                            <div class="col-md-3 col-6">
                                                <div class="mag img-fluid">
                                                    <br />
                                            ...
                                            <div class="col-md-3 col-6">
                                                <div class="mag img-fluid">
                                                    <br />
                                                    <img data-toggle="magnify" src="<?php echo e(asset('img/authors/avatar2.jpg')); ?>" alt="" class="thumbnail img-fluid"></div>
                                            </div>
                                            <div class="col-md-3 col-6">
                                                <div class="mag img-fluid">
                                                    <br />
                                                    <img data-toggle="magnify" src="<?php echo e(asset('img/authors/avatar.jpg')); ?>" alt="" class="thumbnail img-fluid"></div>
                                            </div>
                                            ...
                                            <div class="col-md-3 col-6">
                                                <div class="mag img-fluid">
                                                    <br />
                                                    <img data-toggle="magnify" class="thumbnail img-fluid" src="<?php echo e(asset('img/authors/avatar1.jpg')); ?>" alt=""></div>
                                            </div>
                                            <div class="col-md-3 col-6">
                                                <div class="mag img-fluid">
                                                    <br />
                                        ...
                                        <div class="activity">
                                            <div class="imgs-profile media">
                                                <a class="float-left" href="#">
                                                    <img class="media-object rounded-circle mr-3" src="<?php echo e(asset('img/authors/avatar.jpg')); ?>" alt=""></a>
                                            ...
                                            <div class="imgs-profile media">
                                                <a class="float-left" href="#">
                                                    <img class="media-object rounded-circle img-fluid mr-3" src="<?php echo e(asset('img/authors/avatar1.jpg')); ?>" alt=""></a>
                                                <div class="media-body">
                                                    ...
                                                    <div class="media blog-media">
                                                        <a class="float-left" href="#">
                                                            <img class="media-object thumbnail mr-3" src="<?php echo e(asset('img/authors/avatar2.jpg')); ?>" alt=""></a>
                                            ...
                                            <div class="imgs-profile media">
                                                <a class="float-left" href="#">
                                                    <img class="media-object rounded-circle mr-3" src="<?php echo e(asset('img/authors/avatar3.jpg')); ?>" alt=""></a>
                                                <div class="media-body">
                                            ...
                                            <div class="imgs-profile media">
                                                <a class="float-left" href="#">
                                                    <img class="media-object rounded-circle mr-3" src="<?php echo e(asset('img/authors/avatar4.jpg')); ?>" alt=""></a>
                                                <div class="media-body">
                                                    ...
                                                    <ul class="uploadphoto-list">
                                                        <li>
                                                            <a href="<?php echo e(asset('img/authors/avatar2.jpg')); ?>" data-rel="prettyPhoto">
                                                                <img src="<?php echo e(asset('img/authors/avatar2.jpg')); ?>" class="thumbnail img-fluid" alt=""></a>
                                                        </li>
                                                        <li>
                                                            <a href="<?php echo e(asset('img/authors/avatar3.jpg')); ?>" data-rel="prettyPhoto">
                                                                <img src="<?php echo e(asset('img/authors/avatar3.jpg')); ?>" class="thumbnail img-fluid" alt=""></a>
                                                        </li>
                                                        <li>
                                                            <a href="<?php echo e(asset('img/authors/avatar.jpg')); ?>" data-rel="prettyPhoto">
                                                                <img src="<?php echo e(asset('img/authors/avatar.jpg')); ?>" class="thumbnail img-fluid" alt=""></a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                            ...
                                            <div class="imgs-profile media">
                                                <a class="float-left" href="#">
                                                    <img class="media-object rounded-circle mr-3" src="<?php echo e(asset('img/authors/avatar7.jpg')); ?>" alt=""></a>
                                                <div class="media-body">
                                            ...
                                            <div class="imgs-profile media">
                                                <a class="float-left" href="#">
                                                    <img class="media-object rounded-circle mr-3" src="<?php echo e(asset('img/authors/avatar2.jpg')); ?>" alt=""></a>
                                                <div class="media-body">
                                                    <strong>Lenny</strong>
                                                    posted a new note.
                                                    <br>
                                            ...
                                            <div class="imgs-profile media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <div class="media blog-media">
                                                        <a class="float-left" href="#">
                                                            <img class="media-object thumbnail mr-3" src="<?php echo e(asset('img/authors/avatar4.jpg')); ?>" alt=""></a>
                                            ...
                                            <div class="imgs-profile media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <div class="mb20"></div>
                                                    <a href="<?php echo e(asset('img/authors/avatar.jpg')); ?>" data-rel="prettyPhoto" class="img-single">
                                                        <img src="<?php echo e(asset('img/authors/avatar.jpg')); ?>" class="thumbnail img-fluid" alt=""></a>
                                                </div>
                                            </div>
                                            <!-- media -->
...
<?php $__env->startSection('footer_scripts'); ?>
    ...
    <script src="<?php echo e(asset('vendors/jquery-mockjax/js/jquery.mockjax.js')); ?>"  type="text/javascript"></script>
    
    <script src="<?php echo e(asset('vendors/bootstrap-magnify/bootstrap-magnify.js')); ?>" type="text/javascript"></script>
    ...
    <script src="<?php echo e(asset('js/pages/user_profile.js')); ?>"  type="text/javascript"></script>
...
<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\BSS\resources\views/admin/user_profile.blade.php ENDPATH**/ ?>