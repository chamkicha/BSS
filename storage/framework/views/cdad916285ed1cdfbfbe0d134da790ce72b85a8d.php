...
<link href="<?php echo e(asset('vendors/jquery_steps/css/jquery.steps.css')); ?>" rel="stylesheet" />
<link href="<?php echo e(asset('css/pages/custom_gui_builder.css')); ?>" rel="stylesheet" />
<link href="<?php echo e(asset('vendors/sweetalert/css/sweetalert2.css')); ?>" rel="stylesheet" />
...
<script type="text/javascript" src="<?php echo e(asset('vendors/sweetalert/js/sweetalert2.js')); ?>"></script>
<script src="<?php echo e(asset('vendors/jquery_steps/js/jquery.steps.min.js')); ?>"></script>
<script src="<?php echo e(asset('js/pluginjs/validate.js')); ?>"></script>
<script src="<?php echo e(asset('js/pages/custom_gui_builder.js')); ?>"></script>
<script>
...
<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\BSS\resources\views/infyom/generator-builder/builder.blade.php ENDPATH**/ ?>